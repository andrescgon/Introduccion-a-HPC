...
2. **Version Paralela CPU**: Distribuye el procesamiento usando Multiprocessing (Múltiples Cores)
...
time = sobel_edge_detection_parallel(
    "images/input/pikachu.jpg",
    "images/output/edges_parallel.jpg",
    num_processes=8  # Opcional: especificar numero de cores
)
```
